...
class RoutingDecision:
    ...
    switching_operation_id: Optional[str] = None
...
class RequestRouter:
    ...
    def route_request(self,
                     ...
                     request_id: Optional[str] = None) -> RoutingDecision:
        """
        ...
        target_version, switching_state = self.switching_orchestrator.get_routing_decision(
            model_id, request_id
        )
    ...
    def route_batch_request(self,
                           ...
                           batch_id: Optional[str] = None) -> List[RoutingDecision]:
        """
...
def get_request_router() -> Optional[RequestRouter]:
...
def route_request(model_id: str, request_data: Dict[str, Any], request_id: Optional[str] = None) -> RoutingDecision:
    """
